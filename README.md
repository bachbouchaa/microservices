...
This project compare four major API communication
paradigms: **SOAP/WSDL**, **REST**, **GraphQL**, and **gRPC**.
...
is one of the most important architectural decisions you will make. This project / report examines
